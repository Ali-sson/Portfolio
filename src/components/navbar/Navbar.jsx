     ...
     <div className='container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center'>
        ...
        <nav className='md:ml-auto text-white text-base md:mr-auto flex flex-wrap items-center justify-center'>
          ...
          listNavbar.map((item, index) => (
            <a key={index} href={item.link} className='mr-5 hover:text-gray-500'>
              {item.name}
            </a>
          ))
          }
        ...
        <button className='inline-flex items-center  py-1 px-7 focus:outline-none text-base text-white
